<template>
  <div :class="{readonly: isReadOnly}" class="page">
    <home-header />
    ...
    <div class="pans">
      <html-pan v-show="isVisible('html')" class="pan" />
      <css-pan v-show="isVisible('css')" class="pan" />
      <js-pan v-show="isVisible('js')" class="pan" />
      <console-pan v-show="isVisible('console')" class="pan" />
      <output-pan v-show="isVisible('output')" class="pan" />
    </div>

    <div ref="sponsor" class="sponsor">
      <a href="https://github.com/sponsors/egoist" rel="noopener nofollow" target="_blank">❤️ Sponsor me on GitHub to support the rewrite of CodePan!</a>
    </div>
  </div>
</template>
